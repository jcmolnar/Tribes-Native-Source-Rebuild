...
void EditControl::drawNut(GFXSurface *sfc, const Point2I &nut, bool multisel) // WASM-PORT: const so temps bind
{
...
void EditControl::moveSelection(const Point2I &delta) // WASM-PORT: const so temps bind
{
   Vector<Control *>::iterator i;
