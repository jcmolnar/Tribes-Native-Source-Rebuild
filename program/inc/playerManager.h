...
public:
	...
	static const size_t MaxTeams = 32;   // native: Kronos teams id -1..~15 index teamList[team+1]; 9 overflows
...
public:
	...
	// TODO: Default -1?
	virtual void issueCommand(int cmdrId, int targId, int commandIcon, const char* commandString, const Point2I& wayPoint, int objectIndex = -1);
