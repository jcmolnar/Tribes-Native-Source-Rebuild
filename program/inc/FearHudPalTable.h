...
namespace FearGui
{
	...
	// WASM-PORT: free-function HUD palette init used by FHinventory/HudManager onRender
	// (reconstruction lost it; FGHPaletteTable::InitializeTable is the member twin).
