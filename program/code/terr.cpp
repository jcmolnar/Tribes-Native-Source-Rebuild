...
static Point2F TextureCoor[8][5] =  // WASM-PORT: file-local; engine grdRender.o has its own TextureCoor
{
...
static UInt16 Umax(UInt16 u1, UInt16 u2)  // WASM-PORT: file-local; engine terrData.o has its own Umax
{
   return u1 > u2 ? u1 : u2;
}
