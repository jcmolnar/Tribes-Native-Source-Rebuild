...
void Planet::inspectRead(Inspect *inspect)
{
   ...
   inspect->read(IDITG_SKY_AZIMUTH, azimuth);
   inspect->read(IDITG_SKY_INCIDENCE, incidence);
   inspect->read(IDITG_SIZE, planet.size);
   inspect->read(IDITG_DISTANCE, planet.distance);
